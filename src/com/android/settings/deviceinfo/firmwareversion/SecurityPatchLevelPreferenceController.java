...
public class SecurityPatchLevelPreferenceController extends BasePreferenceController {
    ...
    private static String mCustomPatch;
    ...
    public CharSequence getSummary() {
        if (mContext.getResources().getBoolean(R.bool.config_needsCustomPatch)) {
                mCustomPatch = mContext.getResources().getString(R.string.custom_sec_patch);
        }
        else {
            mCustomPatch = mCurrentPatch;
        }
        return mCustomPatch;
    }
